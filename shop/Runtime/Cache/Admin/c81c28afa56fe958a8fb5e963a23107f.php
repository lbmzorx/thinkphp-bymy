...
<div style="font-size: 13px;margin: 10px 5px">
    ...
    <form action="/index.php/Admin/Auth/add" method="post" enctype="multipart/form-data" id="form1">
            ...
            <tr>
                ...
                <td>
                    <select name="pid">
                        ...
                        <?php if(is_array($auth_father)): $i = 0; $__LIST__ = $auth_father;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vv["id"]); ?>"><?php echo ($vv["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </td>
            </tr>
            <tr>
