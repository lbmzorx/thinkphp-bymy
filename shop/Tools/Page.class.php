...
class Page
{
    ...
    private function first(){
        ...
        if($this->page==1)
            ...
            $html.="&nbsp;&nbsp;<a href='{$this->url}&$this->page=1'>{$this->config['first']}</a>&nbsp;&nbsp;";
    ...
    private function goPage(){
        return '<input type ="text" onkeydown="javascript:if(event.keyCode==13){var page=(this.value>'.$this->pageNum.
            ')?'.$this->pageNum.';this.value;location=\''.$this->url.'&page=\'+page+\'\'}" value="'.$this->page.'"
            style="width:25px"><input type="button" value="GO" onclick="javascript:var page=(this.previousSibling.value>
            '.$this->pageNum.')?'.$this->pageNum.':this.previousSibling.value;location=\''.$this->url.'&page=\'+
            page+\'\'">';
    }
