...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-side-scroll">
            <ul class="layui-nav layui-nav-tree site-demo-nav">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="/index.php/Admin/Default/home" target="main">商品列表</a>
                            <a href="/index.php/Admin/Default/home" target="main">商品管理</a>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="/index.php/Admin/Default/home" target="main">案例列表</a>
                            <a href="/index.php/Admin/Default/home" target="main">案例管理</a>
                            <a href="/index.php/Admin/Default/home" target="main">分类管理</a>
                        </dd>
                    </dl>
                </li>
    ...
    <div class="layui-body iframe-container" style="margin: 15px;">
